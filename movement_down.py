...
#	joint_action = DataConfig.JOINT_0085
#	self._movement(joint_action, self.joint_gap)

	joint_action = DataConfig.JOINT_0086
	self._movement(joint_action, self.joint_gap)

	joint_action = DataConfig.JOINT_0087
	self._movement(joint_action, self.joint_gap)

	for cnt in range(3):
	   joint_action = DataConfig.JOINT_0088
   	   self._movement(joint_action, self.joint_gap)

	   joint_action = DataConfig.JOINT_0089
   	   self._movement(joint_action, self.joint_gap)
