...
class MaicatControl:
    ...
    def _command_print(self):
        ...
        ""
        print
        "                      M O V E M E N T    C O N T R O L 1.0"
        print
        ""
        print
        "   ========================================================================"
        print
        "   # JOINT FIX:", joint_fix, "  # POSTURE:", posture, "  # SOUND:", sound
        print
        "   ------------------------------------------------------------------------"
        print
        "   1. sitdown               21. standup             31. JOINT FIX(on/off)"
        print
        "   2. sitdown eat           22. shake rl            32. SOUND(on/off)"
        print
        "   3. sitdown stretch       23. walk Front"
        print
        "   4. sitdown kneading      24. walk Front Right    41. STATUS: Falldown"
        print
        "   5. sitdown punch         25. walk Front Left     42. STATUS: Sitdown"
        print
        "   6. sitdown lick          26. walk Back           43. STATUS: Standup"
        print
        "   7. sitdown -> falldown   27. walk Back Right"
        print
        "   8. falldown -> sitdown   28. walk Back Left      51. M/C sitdown motion"
        print
        "   9. uplift -> ready"
        print
        "      ready                                         99. QUIT"
        print
        "      uplift -> sitdown                             100. shutdown"
        print
        "   ------------------------------------------------------------------------"
        print
        "   # HEAD normal : 61. right   62. left   63. center   64. l/r view"
        print
        "         nodding : 71. right   72. left   73. center   74. shake"
        print
        "   ------------------------------------------------------------------------"
        print
        "   # SOUND : 81. normal   82. happy   83. grooming   84. angry"
        print
        "   ------------------------------------------------------------------------"
    ...
    def _command_action(self):
        ...
        if self.cmd_nm in [22]:
            if self.cmd_nm_prev in [21]:
                ...
                if self.cmd_nm_prev in [1]:
                    call_data_n = "-ns -0.5 -ne -0.5 -nm 0.2 -c "
                else:
                    call_data_n = "-ns 0.5 -ne 0.5 -nm 0.5 -c "
