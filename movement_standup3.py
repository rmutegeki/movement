...
class MoveACT:
	...
	data = f.readline()
	f.close()
	if int(args.x) == 0 and data not in ["uplift"]: exit()
...
#	joint_action = DataConfig.JOINT_0022
#	self._movement(joint_action)

#	joint_action = DataConfig.JOINT_0021
#	self._movement(joint_action)

#	joint_action = DataConfig.JOINT_0022
#	self._movement(joint_action)

#	joint_action = DataConfig.JOINT_0023
#	self._movement(joint_action)
...
#	joint_action = DataConfig.JOINT_0024
#	self._movement(joint_action)

#	joint_action = DataConfig.JOINT_0025
#	self._movement(joint_action)

#	joint_action = DataConfig.JOINT_0026
#	self._movement(joint_action)
